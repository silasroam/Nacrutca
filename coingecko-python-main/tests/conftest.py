...
from coingecko_sdk import Coingecko, AsyncCoingecko, DefaultAioHttpClient
from coingecko_sdk._utils import is_dict
...
async def async_client(request: FixtureRequest) -> AsyncIterator[AsyncCoingecko]:
    ...
    async with AsyncCoingecko(
        base_url=base_url, pro_api_key=pro_api_key, _strict_response_validation=strict, http_client=http_client
    ) as client:
        yield client
