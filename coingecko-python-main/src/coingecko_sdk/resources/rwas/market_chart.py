...
from ...types.rwas import market_chart_get_params
from ..._base_client import make_request_options
from ...types.rwas.market_chart_get_response import MarketChartGetResponse
...
class MarketChartResource(SyncAPIResource):
    ...
    def get(
        ...
        *,
        ...
        return self._get(
            path_template("/rwas/{id}/market_chart", id=id),
