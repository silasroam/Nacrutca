...
from ...types.rwas import ticker_get_params
from ..._base_client import make_request_options
from ...types.rwas.ticker_get_response import TickerGetResponse
...
class TickersResource(SyncAPIResource):
    ...
    def get(
        ...
        *,
        ...
        issuer_ids: str | Omit = omit,
        order: Literal["last_traded_at_desc", "last_traded_at_asc", "volume_desc", "volume_asc"] | Omit = omit,
        page: int | Omit = omit,
        ...
        Args:
          ...
          issuer_ids: Issuer ID. \\**refers to [`/rwas/issuers/list`](/reference/rwas-issuers-list)

          order: Sort the order of responses. Default: last_traded_at_desc
        ...
        return self._get(
            path_template("/rwas/{id}/tickers", id=id),
